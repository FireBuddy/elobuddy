...
namespace PartyJanna.Functions
{
    public static class Harass
    {
        ...
        public static void Execute()
        {
            ...
            {
                if (Config.Harass.UseQ.CurrentValue && Player.Instance.Mana >= Config.Spells.manaQ[Config.Spells.Q.Level])
                {
                ...
                if (Config.Harass.UseW.CurrentValue && Player.Instance.Mana >= Config.Spells.manaW[Config.Spells.W.Level])
                {
